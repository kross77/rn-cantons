...
const withSwipe = (WrappedComponent, swipeConfig = defaultConfig) => { var _a; return _a = class extends Component {
        constructor(props, context) {
            super(props, context);
            this.moveX = new Animated.Value(0);
            this.onMoveResponder = (_, { dy, dx }) => this.props.onMove &&
                this.props.onMove({
                    dx, dy
                });
        ...
        render() {
            return (React.createElement(WrappedComponent, Object.assign({}, this._panResponder && this._panResponder.panHandlers, Object.assign({}, this.props))));
        }
    },
    _a.defaultProps = {
...
//# sourceMappingURL=withSwipe.js.map