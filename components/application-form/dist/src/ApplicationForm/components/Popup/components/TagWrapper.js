...
const filled = wrap(TouchableOpacity, upgrade(defaultWrapper, ({ fill = Colors.B800 }) => ({
    color: fill,
    borderRadius: 20,
    borderColor: fill,
    borderWidth: 1,
...
const TagWrapper = wrap(upgrade(Layout, { pv: 0, width: "auto" }), createTypeComponent({
    defaultWrapper: wrap(TouchableOpacity, defaultWrapper),
    filled
}));
export default TagWrapper;
//# sourceMappingURL=TagWrapper.js.map