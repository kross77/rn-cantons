export declare type EmptyField = undefined | null;
export declare type StringField = string;
export declare type MultilineField = string;
export declare type PhoneField = string;
export declare type PhotosField = string[];
export declare type SelectField<T> = T;
export declare type NumberField = number;
export declare type RatingField = number;
export declare type NumberOptionsField = {
    inputValue: string;
    optionValue: string;
};
